...
@Component
public class LocalEsafResponseProcessor implements ResponseProcessor {
    private final PublicApiWorkerTaskType publicApiWorkerTaskType = PublicApiWorkerTaskType.LOCAL_ESAF;
    ...
    public PublicApiWorkerTaskType getWorkerTaskType() {
        return publicApiWorkerTaskType;
    }
}
